...
COIN_REPO='https://github.com/BitcoinZeroOfficial/bitcoinzero/releases/download/5.0.3.3/linux-x64.tar.gz'
COIN_NAME='BZX'
COIN_RPC=29202
COIN_PORT=29301
...
function enable_firewall() {
  echo -e "Installing and setting up firewall to allow ingress on port ${CYAN}$COIN_PORT${NC}"
